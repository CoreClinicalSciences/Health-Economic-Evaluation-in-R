...
Step 2: Calculate the proportion of individuals in each state for years 1-20 (Monotherapy), their life-years, and costs
...
Step 4: Repeat the analysis for the combination therapy. Use table 2.2 part 1(b) as a guide to calculate the combination transition matrix. Recall that the combination therapy is only use for the first two years of treatment.
