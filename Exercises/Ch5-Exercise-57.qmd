...
generateSimulations <- function(nReps = 1000,age=60,male=0,cRatio = 100000){
   ...
   dfReturn <- data.frame(matrix(NA,nrow = nReps,ncol = 23))
  
   #fill out the column names for our dataframe
   colnames(dfReturn) <- c("omrPTHR","omrRTHR","rrNP1","rrr","lambda","gamma","cPrimary","cRevision","cSuccess","uSuccessP","uSuccessR","uRevision",
                          "cRatio","STDCost","STDQALYS","NP1Cost","NP1QALYS","STDNMB","NP1NMB","NP1Inc","CESTD","CENP1","CINP1Inc")
